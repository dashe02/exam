...
public class ConsistentHash<T> {
    ...
    static class HashFunction {
        int hash(Object key) {
            //md5加密后，hashcode
            return DigestUtils.MD5(key.toString()).hashCode();
        }
    }
    ...
    public static void main(String [] args) {
        ...
        ConsistentHash< String> consistentHash = new ConsistentHash<String>( new HashFunction(), 4, set);
